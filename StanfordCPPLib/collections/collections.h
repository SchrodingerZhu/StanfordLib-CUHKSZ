 ...
 */
    ...
    template<typename CollectionTypeA, typename CollectionTypeB>
    bool real_compare(const CollectionTypeA &coll1, const CollectionTypeB &coll2, std::false_type) {
        auto itr1 = coll1.begin();
        auto end1 = coll1.end();
    ...
    template<typename CollectionTypeA, typename CollectionTypeB>
    bool equals(const CollectionTypeA &coll1, const CollectionTypeB &coll2) {
        // optimization: if literally same collection, stop
        if (is_same_thing(coll1, coll2)) {
            return true;
        }
 ...
 */
    ...
    public:
         ...
         * and the like.
         */
        template<typename OtherItr> friend
        class CheckedIterator;
 ...
 */
    ...
    public:
        ...
        /* Comparison operators. */
        template<typename OtherItr>
        bool operator==(const ProjectingIterator<OtherItr> &rhs) {
            return _iter == rhs._iter;
        }
 ...
 */
    ...
    std::istream &operator>>(std::istream &is, GenericSet<SetTraits> &set) {
        ...
        return stanfordcpplib::collections::readCollection(is, set, element, /* descriptor */
                                                           SetTraits::name() + "::operator >>");
    }
